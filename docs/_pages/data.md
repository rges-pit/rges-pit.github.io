...
beginner and advanced. You can learn more about the 2026 data challenge [here](https://rges-pit.org/data-challenge/){:target="_blank"}.
...
Working Group 6 has generated a self-consistent library of variable star lightcurves with a Roman noise model 
that can be used to test microlensing classifier software. Some primary objectives of this work are, (1) compile catalogs 
of real variable star light curves from prior surveys in the GBTDS footprint, (2) generate a catalog of simulated light curves, 
(3) resample the light curves to mimic GBTDS-like sensitivity, cadence, etc, and finally (4) transform the resampled light curves 
from the original passbands to the primary filters that the GBTDS will utilize. The stellar variability types that currently exist 
in the catalog are as follows:
...
For a programmatically-generated Table of all pre- and post-launch data products from the RGES PIT, please visit 
this [global pipeline page](https://pipeline.rges-pit.org/public_data){:target="_blank"}.
