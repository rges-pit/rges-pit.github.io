...
<div style="display: flex; gap: 10px; margin: 1em 0; align-items: center;">
  ...
  <a href="https://github.com/rges-pit/data-challenge-notebooks/blob/main/binary_lens_grid_search.ipynb" 
     style="background-color: #24292e; color: white; padding: 8px 16px; text-decoration: none; border-radius: 4px; font-size: 14px; display: inline-flex; align-items: center; gap: 5px;">
  ...
  <a href="#" 
     onclick="downloadNotebook('https://github.com/rges-pit/data-challenge-notebooks/raw/main/binary_lens_grid_search.ipynb', 'binary_lens_grid_search.ipynb')"
