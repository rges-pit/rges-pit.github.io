...
* [`eesunhong`](https://github.com/rges-pit/eesunhong){:target="_blank"} - microlensing modeling code using image-centered ray shooting; Maintained: Yes (Olmschenk); [Bennett & Rhie (1996)](https://ui.adsabs.harvard.edu/abs/1996ApJ...472..660B/abstract){:target="_blank"}, [Bennett (2010)](https://ui.adsabs.harvard.edu/abs/2010ApJ...716.1408B/abstract){:target="_blank"}
* [`lcbinint`](https://github.com/NunotaKansuke/lcbinint){:target="_blank"} — python package with a C++ core for binary-lens microlensing magnification and light-curve calculations; Maintained: Yes (Nunota)
* [`MicroJAX`](https://github.com/ShotaMiyazaki94/microjax){:target="_blank"} — fully‑differentiable, GPU‑accelerated software for modeling microlensing light curves produced by binary, and triple lens systems, uses the image-centered ray shooting (ICRS) method of Bennett+2010; Maintained: Yes (Miyazaki); [Miyazaki & Kawahara (2025)](https://ui.adsabs.harvard.edu/abs/2025ApJ...994..144M/abstract){:target="_blank"}
...
* [`gapmoe`](https://github.com/NunotaKansuke/gapmoe){:target="_blank"} — code to construct Galactic microlensing priors from event-local histogram products generated by `genulens`; Maintained: Yes (Nunota) 
...
* [`jacscanomaly`](https://github.com/NunotaKansuke/jacscanomaly){:target="_blank"} — python package for scan-based anomaly detection in time-series light curves.; Maintained: Yes (Nunota)
